Shader "Unreal/MI_KYT_HydrangeaLeaf01"
{
    Properties
    {
		...
		Material_Texture2D_2( "BaseColorTexture", 2D ) = "white" {}
		Material_Texture2D_3( "MaskTexture", 2D ) = "white" {}
		Material_Texture2D_4( "WPO_Alpha", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_KYT_HydrangeaLeaf01.hlsl"
