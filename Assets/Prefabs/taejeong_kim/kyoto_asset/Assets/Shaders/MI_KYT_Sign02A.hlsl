...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[6] = float4(0.200000,1.000000,1.000000,0.000000);//(Unknown)
...
{
	MaterialCollection0.Vectors[0] = float4(0.000000,0.000000,0.000000,172911536.000000);//Rain,,,
}
