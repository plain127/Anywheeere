...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.536458,0.463008,0.430431,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.500000,1.300000,-0.300000,1.000000);//(Unknown)
...
{
	MaterialCollection1.Vectors[0] = float4(0.000000,0.000000,2352.000000,0.000000);//Emissive,,,
}
