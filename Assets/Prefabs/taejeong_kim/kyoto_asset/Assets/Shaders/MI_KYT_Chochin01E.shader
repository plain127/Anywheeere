Shader "Unreal/MI_KYT_Chochin01E"
{
    Properties
    {
		...
		Material_Texture2D_0( "TX_KYT_BaseNormal", 2D ) = "white" {}
		Material_Texture2D_1( "NormalTexture", 2D ) = "white" {}
		Material_Texture2D_2( "Master02_NormalTexture", 2D ) = "white" {}
		Material_Texture2D_3( "LayerBlendMask_Texture", 2D ) = "white" {}
		Material_Texture2D_4( "MaskTexture", 2D ) = "white" {}
		Material_Texture2D_5( "Master02_MaskTexture", 2D ) = "white" {}
		Material_Texture2D_6( "BaseColorTexture", 2D ) = "white" {}
		Material_Texture2D_7( "ColorMaskTexture", 2D ) = "white" {}
		Material_Texture2D_8( "Master02_BaseColorTexture", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_KYT_Chochin01E.hlsl"
