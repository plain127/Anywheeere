...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.515625,0.515625,0.515625,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.500000,1.100000,-0.100000,0.800000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
...
{
	MaterialCollection0.Vectors[0] = float4(0.000000,0.000000,-2558901289365395292554083314958336.000000,0.000000);//Rain,,,
}
...
{
	MaterialCollection1.Vectors[0] = float4(0.000000,0.000000,-2556128303677396040738309276696576.000000,0.000000);//Emissive,,,
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local35 = (Local25.r * Material.PreshaderBuffer[4].x);
	...
	PixelMaterialInputs.AmbientOcclusion = Local35.r;
