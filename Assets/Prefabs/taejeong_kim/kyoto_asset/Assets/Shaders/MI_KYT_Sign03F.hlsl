...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.098958,0.098958,0.098958,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[6] = float4(0.800000,1.000000,1.000000,0.000000);//(Unknown)
...
{
	MaterialCollection0.Vectors[0] = float4(0.000000,0.000000,128485.312500,0.000002);//Rain,,,
}
