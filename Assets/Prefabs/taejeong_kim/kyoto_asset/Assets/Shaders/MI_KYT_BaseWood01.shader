Shader "Unreal/MI_KYT_BaseWood01"
{
    Properties
    {
		...
		Material_Texture2D_0( "DetailNormalTexture", 2D ) = "white" {}
		Material_Texture2D_1( "TX_KYT_BaseNormal", 2D ) = "white" {}
		Material_Texture2D_2( "NormalTexture", 2D ) = "white" {}
		Material_Texture2D_3( "BaseColorTexture", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_KYT_BaseWood01.hlsl"
