...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.038219,0.053916,0.088542,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.364583,0.364583,0.364583,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1.000000,0.500000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.500000,1.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,0.400000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.000000,0.500000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(10.000000,1.000000,0.070000,1.000000);//(Unknown)
...
{
	MaterialCollection0.Vectors[0] = float4(0.000000,0.000000,-2536341070089458522424321675100160.000000,0.000000);//Rain,,,
}
...
{
	MaterialCollection1.Vectors[0] = float4(0.000000,0.000000,-2536638175698887013690297464913920.000000,0.000000);//Emissive,,,
}
float3 GetMaterialWorldPositionOffset(FMaterialVertexParameters Parameters)
{
	MaterialFloat Local63 = (View.GameTime * Material.PreshaderBuffer[6].y);
	MaterialFloat Local64 = (Local63 * -0.50000000);
	MaterialFloat3 Local65 = (normalize(MaterialFloat4(0.00000000,1.00000000,0.00000000,1.00000000).rgba.rgb) * ((MaterialFloat3)Local64));
	FWSVector3 Local66 = GetWorldPosition(Parameters);
	FWSVector3 Local67 = MakeWSVector(WSGetX(DERIV_BASE_VALUE(Local66)), WSGetY(DERIV_BASE_VALUE(Local66)), WSGetZ(DERIV_BASE_VALUE(Local66)));
	FWSVector3 Local68 = WSDivideByPow2(DERIV_BASE_VALUE(Local67), ((MaterialFloat3)1024.00000000));
	FWSVector3 Local69 = WSAdd(Local65, DERIV_BASE_VALUE(Local68));
	FWSVector3 Local70 = WSAdd(DERIV_BASE_VALUE(Local69), ((MaterialFloat3)0.50000000));
	MaterialFloat3 Local71 = WSFracDemote(DERIV_BASE_VALUE(Local70));
	MaterialFloat3 Local72 = (DERIV_BASE_VALUE(Local71) * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local73 = (DERIV_BASE_VALUE(Local72) + ((MaterialFloat3)-1.00000000));
	MaterialFloat3 Local74 = abs(DERIV_BASE_VALUE(Local73));
	MaterialFloat3 Local75 = (DERIV_BASE_VALUE(Local74) * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local76 = (((MaterialFloat3)3.00000000) - DERIV_BASE_VALUE(Local75));
	MaterialFloat3 Local77 = (DERIV_BASE_VALUE(Local76) * DERIV_BASE_VALUE(Local74));
	MaterialFloat3 Local78 = (DERIV_BASE_VALUE(Local77) * DERIV_BASE_VALUE(Local74));
	MaterialFloat Local79 = dot(normalize(MaterialFloat4(0.00000000,1.00000000,0.00000000,1.00000000).rgba.rgb),DERIV_BASE_VALUE(Local78));
	FWSVector3 Local80 = WSDivide(DERIV_BASE_VALUE(Local67), ((MaterialFloat3)200.00000000));
	FWSVector3 Local81 = WSAdd(((MaterialFloat3)Local64), DERIV_BASE_VALUE(Local80));
	FWSVector3 Local82 = WSAdd(DERIV_BASE_VALUE(Local81), ((MaterialFloat3)0.50000000));
	MaterialFloat3 Local83 = WSFracDemote(DERIV_BASE_VALUE(Local82));
	MaterialFloat3 Local84 = (DERIV_BASE_VALUE(Local83) * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local85 = (DERIV_BASE_VALUE(Local84) + ((MaterialFloat3)-1.00000000));
	MaterialFloat3 Local86 = abs(DERIV_BASE_VALUE(Local85));
	MaterialFloat3 Local87 = (DERIV_BASE_VALUE(Local86) * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local88 = (((MaterialFloat3)3.00000000) - DERIV_BASE_VALUE(Local87));
	MaterialFloat3 Local89 = (DERIV_BASE_VALUE(Local88) * DERIV_BASE_VALUE(Local86));
	MaterialFloat3 Local90 = (DERIV_BASE_VALUE(Local89) * DERIV_BASE_VALUE(Local86));
	MaterialFloat3 Local91 = (DERIV_BASE_VALUE(Local90) - ((MaterialFloat3)0.00000000));
	MaterialFloat Local92 = length(DERIV_BASE_VALUE(Local91));
	MaterialFloat Local93 = (DERIV_BASE_VALUE(Local79) + DERIV_BASE_VALUE(Local92));
	MaterialFloat Local94 = (DERIV_BASE_VALUE(Local93) * 6.28318548);
	MaterialFloat4 Local95 = MaterialFloat4(cross(normalize(MaterialFloat4(0.00000000,1.00000000,0.00000000,1.00000000).rgba.rgb),MaterialFloat3(0.00000000,0.00000000,1.00000000).rgb),DERIV_BASE_VALUE(Local94));
	FWSVector3 Local96 = TransformLocalPositionToWorld(Parameters, MaterialFloat3(0.00000000,0.00000000,0.00000000).rgb);
	FWSVector3 Local97 = WSAdd(Local96, Material.PreshaderBuffer[7].xyz);
	FWSVector3 Local98 = WSSubtract(DERIV_BASE_VALUE(Local67), Local97);
	MaterialFloat3 Local99 = WSDemote(DERIV_BASE_VALUE(Local98));
	MaterialFloat Local100 = length(DERIV_BASE_VALUE(Local99));
	MaterialFloat Local101 = (DERIV_BASE_VALUE(Local100) / 256.00000000);
	FWSVector3 Local102 = WSAdd(((MaterialFloat3)View.GameTime), GetObjectWorldPosition(Parameters));
	FWSVector3 Local103 = WSMultiply(Local102, ((MaterialFloat3)Material.PreshaderBuffer[7].w));
	FWSVector3 Local104 = WSMultiply(Local103, ((MaterialFloat3)0.62831855));
	MaterialFloat3 Local105 = WSSin(Local104);
	MaterialFloat3 Local106 = (((MaterialFloat3)1.00000000) + DERIV_BASE_VALUE(Local105));
	MaterialFloat3 Local107 = (DERIV_BASE_VALUE(Local106) * ((MaterialFloat3)0.50000000));
	MaterialFloat3 Local108 = (MaterialFloat3(1.00000000,1.00000000,0.00000000).rgb * DERIV_BASE_VALUE(Local107));
	MaterialFloat3 Local109 = (((MaterialFloat3)DERIV_BASE_VALUE(Local101)) * DERIV_BASE_VALUE(Local108));
	MaterialFloat3 Local110 = (((MaterialFloat3)Material.PreshaderBuffer[8].x) * DERIV_BASE_VALUE(Local109));
	MaterialFloat4 Local111 = Parameters.VertexColor;
	MaterialFloat Local112 = DERIV_BASE_VALUE(Local111).r;
	MaterialFloat3 Local113 = (DERIV_BASE_VALUE(Local110) * ((MaterialFloat3)DERIV_BASE_VALUE(Local112)));
	MaterialFloat3 Local114 = (DERIV_BASE_VALUE(Local113) + MaterialFloat3(0.00000000,0.00000000,-10.00000000).rgb);
	MaterialFloat3 Local115 = RotateAboutAxis(DERIV_BASE_VALUE(Local95),DERIV_BASE_VALUE(Local114),DERIV_BASE_VALUE(Local113));
	MaterialFloat3 Local116 = (Local115 * ((MaterialFloat3)Material.PreshaderBuffer[8].y));
	MaterialFloat3 Local117 = (Local116 * ((MaterialFloat3)Material.PreshaderBuffer[8].z));
	MaterialFloat3 Local118 = (Local117 + DERIV_BASE_VALUE(Local113));
	MaterialFloat2 Local119 = Parameters.TexCoords[0].xy;
	MaterialFloat4 Local120 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleLevel(Material_Texture2D_8,samplerMaterial_Texture2D_8,DERIV_BASE_VALUE(Local119),-1.00000000));
	MaterialFloat3 Local121 = (Local118 * Local120.rgb);
	return Local121;;
}
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local122 = (Local39.r * Material.PreshaderBuffer[8].w);
	MaterialFloat Local123 = (Local43.r * Material.PreshaderBuffer[9].x);
	MaterialFloat Local124 = lerp(Local122,Local123,Local15.rgb.x);
	...
	PixelMaterialInputs.AmbientOcclusion = Local124;
