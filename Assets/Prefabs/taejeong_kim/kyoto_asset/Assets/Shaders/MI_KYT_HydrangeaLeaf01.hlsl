...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.200000,0.000000,0.500000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,10.000000,1.000000,0.050000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(2.500000,0.000000,1.000000,0.000000);//(Unknown)
...
{
	MaterialCollection1.Vectors[0] = float4(0.000000,0.000000,-228575150329552956301476541774168064.000000,0.000000);//Emissive,,,
}
