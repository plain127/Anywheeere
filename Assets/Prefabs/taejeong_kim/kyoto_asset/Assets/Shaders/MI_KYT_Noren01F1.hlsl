...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.088542,0.037902,0.021880,0.000000);//(Unknown)
...
{
	MaterialCollection0.Vectors[0] = float4(0.000000,0.000000,0.000000,0.500000);//Rain,,,
}
...
{
	MaterialCollection1.Vectors[0] = float4(0.000000,0.000000,0.000000,0.500000);//Emissive,,,
}
