...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.600000,0.000000,0.500000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,10.000000,5.000000,0.050000);//(Unknown)
