...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.218750,0.218750,0.218750,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[6] = float4(0.500000,1.000000,1.000000,0.000000);//(Unknown)
