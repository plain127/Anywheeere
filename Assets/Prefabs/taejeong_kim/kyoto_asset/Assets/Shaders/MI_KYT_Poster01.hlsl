...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.578125,0.438777,0.374349,0.000000);//(Unknown)
...
{
	MaterialCollection1.Vectors[0] = float4(0.000000,0.000000,-2555583610060110473417353662038016.000000,0.000000);//Emissive,,,
}
