...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.049145,0.143811,0.187500,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1.000000,0.500000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,1.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local14 = (Material.PreshaderBuffer[3].xyz * Local11.rgb);
	MaterialFloat3 Local15 = (((MaterialFloat3)Material.PreshaderBuffer[3].w) * Local14);
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local4), 3);
	MaterialFloat4 Local17 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local4),View.MaterialTextureMipBias));
	MaterialFloat Local18 = MaterialStoreTexSample(Parameters, Local17, 3);
	MaterialFloat3 Local19 = lerp(Local13,Local15,Local17.rgb);
	...
	MaterialFloat4 Local30 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local4),View.MaterialTextureMipBias));
	MaterialFloat Local31 = MaterialStoreTexSample(Parameters, Local30, 3);
	MaterialFloat Local32 = (Local30.b * Material.PreshaderBuffer[4].x);
	MaterialFloat Local33 = (1.00000000 - Local30.g);
	MaterialFloat Local34 = (Material.PreshaderBuffer[4].y * Local33);
	MaterialFloat Local35 = lerp(Material.PreshaderBuffer[4].w,Material.PreshaderBuffer[4].z,Local34);
	MaterialFloat Local36 = saturate(Local35);
	MaterialFloat Local37 = (Local30.g * Material.PreshaderBuffer[5].x);
	MaterialFloat Local38 = lerp(Local37,0.20000000,Local26);
	MaterialFloat Local39 = lerp(Local37,Local38,Local28.r);
	MaterialFloat Local40 = (Local30.r * Material.PreshaderBuffer[5].y);
	...
	PixelMaterialInputs.Metallic = Local32.r;
	PixelMaterialInputs.Specular = Local36.r.r;
	PixelMaterialInputs.Roughness = Local39.r;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local8.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local40.r;
