...
{
	Material.PreshaderBuffer[0] = float4(0.600000,1.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.458333,0.458333,0.458333,1.000000);//(Unknown)
...
{
	MaterialCollection1.Vectors[0] = float4(0.000000,0.000000,-46269246908330373154629666996224.000000,0.000000);//Emissive,,,
}
