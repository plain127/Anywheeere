...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.500000,1.150000,-0.150000,0.800000);//(Unknown)
...
{
	MaterialCollection0.Vectors[0] = float4(0.000000,0.000000,-46280078883674120232035034333184.000000,0.000000);//Rain,,,
}
...
{
	MaterialCollection1.Vectors[0] = float4(0.000000,0.000000,-46304837684459827837533016817664.000000,0.000000);//Emissive,,,
}
