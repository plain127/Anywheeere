...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.000000,1.250000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.343750,0.324834,0.190488,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.150000,0.250000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.000000,0.000000,1.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local34 = (Local26 * ((MaterialFloat3)Material.PreshaderBuffer[7].x));
	MaterialFloat Local35 = PositiveClampedPow(Local28.r,Material.PreshaderBuffer[7].z);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local34,Material.PreshaderBuffer[7].y);
