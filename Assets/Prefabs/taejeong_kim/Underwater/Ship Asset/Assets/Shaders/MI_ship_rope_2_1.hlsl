...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[23] = float4(1.000000,0.400000,0.004000,3.000000);//(Unknown)
	Material.PreshaderBuffer[24] = float4(0.400000,0.004000,3.000000,0.000000);//(Unknown)
...
{
	MaterialFloat Local146 = (View.GameTime * Material.PreshaderBuffer[23].y);
	FWSVector3 Local147 = GetWorldPosition(Parameters);
	FWSVector3 Local148 = MakeWSVector(WSGetX(DERIV_BASE_VALUE(Local147)), WSGetY(DERIV_BASE_VALUE(Local147)), WSGetZ(DERIV_BASE_VALUE(Local147)));
	FWSScalar Local149 = WSGetX(DERIV_BASE_VALUE(Local148));
	FWSScalar Local150 = WSMultiply(DERIV_BASE_VALUE(Local149), Material.PreshaderBuffer[23].z);
	FWSScalar Local151 = WSAdd(Local146, DERIV_BASE_VALUE(Local150));
	FWSScalar Local152 = WSMultiply(DERIV_BASE_VALUE(Local151), 6.28318548);
	MaterialFloat Local153 = WSSin(DERIV_BASE_VALUE(Local152));
	MaterialFloat Local154 = (DERIV_BASE_VALUE(Local153) * Material.PreshaderBuffer[23].w);
	MaterialFloat Local155 = (View.GameTime * Material.PreshaderBuffer[24].x);
	FWSScalar Local156 = WSGetY(DERIV_BASE_VALUE(Local148));
	FWSScalar Local157 = WSMultiply(DERIV_BASE_VALUE(Local156), Material.PreshaderBuffer[24].y);
	FWSScalar Local158 = WSAdd(Local155, DERIV_BASE_VALUE(Local157));
	FWSScalar Local159 = WSMultiply(DERIV_BASE_VALUE(Local158), 6.28318548);
	MaterialFloat Local160 = WSSin(DERIV_BASE_VALUE(Local159));
	MaterialFloat Local161 = (DERIV_BASE_VALUE(Local160) * Material.PreshaderBuffer[24].z);
	MaterialFloat Local162 = (DERIV_BASE_VALUE(Local154) + DERIV_BASE_VALUE(Local161));
	MaterialFloat Local163 = (View.GameTime * Material.PreshaderBuffer[24].w);
	FWSScalar Local164 = WSGetZ(DERIV_BASE_VALUE(Local148));
	FWSScalar Local165 = WSMultiply(DERIV_BASE_VALUE(Local164), Material.PreshaderBuffer[25].x);
	FWSScalar Local166 = WSAdd(Local163, DERIV_BASE_VALUE(Local165));
	FWSScalar Local167 = WSMultiply(DERIV_BASE_VALUE(Local166), 6.28318548);
	MaterialFloat Local168 = WSSin(DERIV_BASE_VALUE(Local167));
	MaterialFloat Local169 = (DERIV_BASE_VALUE(Local168) * Material.PreshaderBuffer[25].y);
	MaterialFloat Local170 = (DERIV_BASE_VALUE(Local162) + DERIV_BASE_VALUE(Local169));
	return Local170;;
}
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local171 = (Local115 * ((MaterialFloat3)Material.PreshaderBuffer[25].z));
	MaterialFloat Local172 = PositiveClampedPow(Local117.r,Material.PreshaderBuffer[26].x);
	MaterialFloat Local173 = PositiveClampedPow(Local121.r,Material.PreshaderBuffer[26].y);
	MaterialFloat Local174 = lerp(Local172,Local173,Local46);
	MaterialFloat Local175 = PositiveClampedPow(Local126.r,Material.PreshaderBuffer[26].z);
	MaterialFloat Local176 = lerp(Local174,Local175,Local57);
	MaterialFloat Local177 = PositiveClampedPow(Local131.r,Material.PreshaderBuffer[26].w);
	MaterialFloat Local178 = lerp(Local176,Local177,Local68);
	MaterialFloat Local179 = lerp(Local178,1.00000000,Local73);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local171,Material.PreshaderBuffer[25].w);
