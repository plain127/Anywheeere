...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,11.000000,11.000000);//(Unknown)
	...
	Material.PreshaderBuffer[4] = float4(1.000000,1.000000,11.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(-1.000000,1.000000,11.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[14] = float4(1.000000,1.000000,1.000000,0.150796);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.861514,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[24] = float4(0.150000,0.200000,0.000000,-1.800000);//(Unknown)
	Material.PreshaderBuffer[25] = float4(0.000000,0.200000,0.000000,-0.800000);//(Unknown)
