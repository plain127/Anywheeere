Shader "Unreal/MI_cannon_1"
{
    Properties
    {
		...
		Material_Texture2D_1( "Masks (RGBA)", 2D ) = "white" {}
		Material_Texture2D_2( "Grunge_channel_RGBA", 2D ) = "white" {}
		Material_Texture2D_3( "moss_Normal", 2D ) = "white" {}
		Material_Texture2D_4( "Noise_moss", 2D ) = "white" {}
		Material_Texture2D_5( "1_Base_Texture", 2D ) = "white" {}
		Material_Texture2D_6( "moss_Base_Texture", 2D ) = "white" {}
		Material_Texture2D_7( "2_Masks (Occ,Rough,Met)", 2D ) = "white" {}
		Material_Texture2D_8( "moss_Mask", 2D ) = "white" {}
