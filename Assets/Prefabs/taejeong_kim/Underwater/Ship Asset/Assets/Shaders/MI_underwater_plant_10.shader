Shader "Unreal/MI_underwater_plant_10"
{
    Properties
    {
		...
		Material_Texture2D_1( "1_Base_Texture", 2D ) = "white" {}
		Material_Texture2D_2( "2_Masks (Occ,Rough,Met)", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_underwater_plant_10.hlsl"
