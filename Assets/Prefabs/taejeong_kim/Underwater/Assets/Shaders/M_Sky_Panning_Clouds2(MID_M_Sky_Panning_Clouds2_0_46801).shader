Shader "Unreal/M_Sky_Panning_Clouds2(MID_M_Sky_Panning_Clouds2_0_46801)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        //BLEND_ON Tags { "RenderPipeline"="UniversalPipeline" "RenderType"="Transparent" "UniversalMaterialType" = "Unlit" "Queue"="Transparent" }
        Pass
        {
        ...
        #include "M_Sky_Panning_Clouds2(MID_M_Sky_Panning_Clouds2_0_46801).hlsl"
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            surface.BaseColor = Out.Emission;// IsGammaSpace() ? BaseColor : SRGBToLinear( BaseColor );
