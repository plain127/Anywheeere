...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.043137,0.043137,0.043137,0.300000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.200000,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.BaseColor = Material.PreshaderBuffer[1].xyz;
	PixelMaterialInputs.Metallic = 0.00000000;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[1].w;
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[2].x;
