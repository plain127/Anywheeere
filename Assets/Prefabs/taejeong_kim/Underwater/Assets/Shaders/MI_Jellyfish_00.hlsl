...
{
	Material.PreshaderBuffer[0] = float4(10.000000,2.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(1.000000,0.046875,0.597161,0.250000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.200000,1.330000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local4 = lerp(Local2.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000).rgb,Material.PreshaderBuffer[0].x);
	...
	MaterialFloat3 Local8 = (Local6.rgb * ((MaterialFloat3)Material.PreshaderBuffer[0].y));
	MaterialFloat3 Local9 = lerp(Local8,Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[0].z);
	MaterialFloat Local10 = dot(WorldNormalCopy,Parameters.CameraVector);
	MaterialFloat Local11 = max(0.00000000,Local10);
	MaterialFloat Local12 = (1.00000000 - Local11);
	MaterialFloat Local13 = abs(Local12);
	MaterialFloat Local14 = max(Local13,0.00010000);
	MaterialFloat Local15 = PositiveClampedPow(Local14,5.00000000);
	MaterialFloat Local16 = (Local15 * (1.00000000 - 0.04000000));
	MaterialFloat Local17 = (Local16 + 0.04000000);
	MaterialFloat Local18 = lerp(1.00000000,Material.PreshaderBuffer[3].y,Local17);

	PixelMaterialInputs.EmissiveColor = Local9;
	PixelMaterialInputs.Opacity = Material.PreshaderBuffer[3].x;
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local18,0.0f),Material.PreshaderBuffer[3].z);
